...
import { FiMessageSquare, FiUser, FiMapPin, FiImage, FiCalendar } from "react-icons/fi";
            ...
            <Form onSubmit = {(ev)=> {handleSubmit(ev)}}>
                <InputContainer>
                    ...
                    <Input 
                        ...
                        type = 'text'
                        onChange = {(ev) => {handleInputChnage('displayName',ev.target.value)}}
                    />
                </InputContainer>
                <InputContainer>
                ...
                <InputContainer>
                    ...
                    <Input 
                        ...
                        onChange = {(ev) => {handleInputChnage('DOB',ev.target.value)}}
                    />
                </InputContainer>
                <InputContainer style = { { height : "120px" }}>
                    ...
                    <Textfield 
                        ...
                        type = 'text'
                        onChange = {(ev) => {handleInputChnage('bio',ev.target.value)}}
                    />
                </InputContainer>
                <InputContainer>
                    ...
                    <Input 
                        ...
                        type = 'text'
                        onChange = {(ev) => {handleInputChnage('imgSrc',ev.target.value)}}
                    />
                </InputContainer>
                <InputContainer>
                    ...
                    <Input 
                        placeholder = 'City' 
                        type = 'text'
                        onChange = {(ev) => {handleInputChnage('location',ev.target.value)}}
                    />
                </InputContainer>
